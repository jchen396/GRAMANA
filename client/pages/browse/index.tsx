...
const index = () => {
	const [gameRoomNames, setGameRoomNames] = useState<any[]>([]);
	const [showKey, setShowKey] = useState<object>({});
	const parent = useRef<any>(
		[...new Array(100)].map(() => React.createRef())
	);
