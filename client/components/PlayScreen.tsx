...
const PlayScreen = () => {
	...
	return (
		<>
			<div className=" relative mt-20 m-4 sm:m-10 sm:p-10 p-2 w-screen sm:w-full lg:w-1/2 md:3/4 sm:h-4/5 h-1/2 bg-neutral-800 bg-repeat rounded-2xl place-content-center place-items-center">
				<div className=" ">
					<GameHeader
						socketId={socket.id}
				...
				<div className="sm:m-10 grid grid-cols-8 sm:gap-y-4 md:gap-x-2">
					{tiles.map((value, key) => (
						<div
							...
							className={`text-stone-50 text-2xl sm:text-4xl font-bold font-mono rounded-lg sm:w-14 sm:h-14 w-10 h-10 border-2 sm:border-4 border-purple-600 transition ease-in-out delay-50 hover:border-green-100 flex justify-center items-center `}
